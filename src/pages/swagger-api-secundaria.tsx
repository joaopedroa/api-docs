...
function SwaggerApiSecundaria() {
  return (
    <Layout title="API Secundária - Swagger UI" description="Documentação interativa da API secundária">
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ marginTop: '20px' }}>
          <SwaggerUI 
            url="/api-docs/api/api-secundaria.yaml"
            deepLinking={true}
        ...
        <div style={{ marginTop: '40px', padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
          ...
          <p>
            <a href="/api-docs/api/api-secundaria.yaml" download>Download do arquivo YAML</a>
          </p>
        </div>
      </div>
    </Layout>
