...
// Dados da timeline - EDITE AQUI com os dados reais do seu produto
const timelineData = [
  {
    id: 1,
    date: 'Janeiro 2024',
  ...
  },
  {
    ...
    metrics: {
      'Feedback coletado': '500+ respostas',
  ...
  },
  {
    ...
    metrics: {
      'Downloads mobile': '3.000+',
      'Usuários ativos mobile': '1.200',
      'Rating na store': '4.7/5'
    }
  },
  {
    id: 10,
  ...
  },
  {
    ...
    metrics: {
      'Progresso': '70%',
      'Precisão do chatbot': '85%',
      'Tempo restante': '2 semanas'
    }
  },
  {
    id: 12,
...
function TimelinePersonalizada() {
  ...
  const filteredData = filter === 'all' 
    ? timelineData 
    : timelineData.filter(item => item.status === filter);
      ...
      <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
            ...
            />
            <span style={{ color: '#2c3e50', fontWeight: '500' }}>Mostrar métricas</span>
          </label>
        </div>
...
export default TimelinePersonalizada;
